 ...
 * @file     M48x_UART.c
 * @version  V0.01
 * @brief    M480 series UART HAL source file
 *
...
{
    {(uint32_t)UART0_BASE, UART0_MODULE, CLK_CLKSEL1_UART0SEL_HXT, MODULE_NoMsk, UART0_RST, UART0_IRQn, &uart0_var},
    {(uint32_t)UART1_BASE, UART1_MODULE, CLK_CLKSEL1_UART1SEL_HXT, MODULE_NoMsk, UART1_RST, UART1_IRQn, &uart1_var},
    {(uint32_t)UART2_BASE, UART2_MODULE, CLK_CLKSEL3_UART2SEL_HXT, MODULE_NoMsk, UART2_RST, UART2_IRQn, &uart2_var},
    {(uint32_t)UART3_BASE, UART3_MODULE, CLK_CLKSEL3_UART3SEL_HXT, MODULE_NoMsk, UART3_RST, UART3_IRQn, &uart3_var},
    {(uint32_t)UART4_BASE, UART4_MODULE, CLK_CLKSEL3_UART4SEL_HXT, MODULE_NoMsk, UART4_RST, UART4_IRQn, &uart4_var},
    {(uint32_t)UART5_BASE, UART5_MODULE, CLK_CLKSEL3_UART5SEL_HXT, MODULE_NoMsk, UART5_RST, UART5_IRQn, &uart5_var},
