...
#line 1 "D:\\ARM\\ARMCC\\Bin\\..\\include\\stdio.h"
...
#line 47 "D:\\ARM\\ARMCC\\Bin\\..\\include\\stdio.h"
...
#line 136 "D:\\ARM\\ARMCC\\Bin\\..\\include\\stdio.h"


extern FILE __stdin, __stdout, __stderr;
extern FILE *__aeabi_stdin, *__aeabi_stdout, *__aeabi_stderr;

#line 166 "D:\\ARM\\ARMCC\\Bin\\..\\include\\stdio.h"
...
#line 1021 "D:\\ARM\\ARMCC\\Bin\\..\\include\\stdio.h"
...
#line 17 "..\\..\\..\\..\\Library\\StdDriver\\inc\\emac.h"
...
static UI2C_FUNC s_UI2C0HandlerFn = 0;
...
void USCI0_IRQHandler(void)
{
    ...
    u32Status = (((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))->PROTSTS);
    if (s_UI2C0HandlerFn != 0)
    {
...
{
    if ((((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTSTS & (0x1ul << (5))) == (0x1ul << (5)) ? 1:0))
    {
         
        UI2C_ClearTimeoutFlag(((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)));
    }
    else if((u32Status & (0x1ul << (8))) == (0x1ul << (8)))
    {
        ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTSTS = ((0x1ul << (8))));  

        if(m_Event == MASTER_SEND_START)
        {
            ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->TXDAT = ((g_u8DeviceAddr << 1) | 0x00));  
            m_Event = MASTER_SEND_ADDRESS;
        }
        else if(m_Event == MASTER_SEND_REPEAT_START)
        {
            ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->TXDAT = ((g_u8DeviceAddr << 1) | 0x01));  
            m_Event = MASTER_SEND_H_RD_ADDRESS;
        }

        ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL = ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL & ~0x2EU) | (0x20UL));
    }
    else if((u32Status & (0x1ul << (13))) == (0x1ul << (13)))
    {
        ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTSTS = ((0x1ul << (13))));   

        if(m_Event == MASTER_SEND_ADDRESS)
        {
            ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->TXDAT = (g_au8MstTxData[g_u8MstDataLen++]));   
        ...
        else if(m_Event == MASTER_SEND_DATA)
        {
            ...
            else
            {
                ...
                ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL = ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL & ~0x2EU) | ((0x20UL | 0x08UL)));     
            }
        }
    ...
    else if((u32Status & (0x1ul << (10))) == (0x1ul << (10)))
    {
        ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTSTS = ((0x1ul << (10))));  
        ...
        {
            g_u8MstRxData = (unsigned char) ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->RXDAT) & 0xFF;
            m_Event = MASTER_STOP;
            ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL = ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL & ~0x2EU) | ((0x20UL | 0x04UL)));     
        }
        else
             
            printf("Status 0x%x is NOT processed\n", u32Status);
    }
    else if((u32Status & (0x1ul << (9))) == (0x1ul << (9)))
    {
        ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTSTS = ((0x1ul << (9))));   
        ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL = ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL & ~0x2EU) | (0x20UL));
        g_u8MstEndFlag = 1;
    }
}
...
void SYS_Init(void)
{
    ...
    CLK_EnableModuleClock(((2UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(8UL<<0)));
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPH = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPH & ~((0xful << (12)) | (0xful << (8)))) |
                    ((0x06UL<<(12)) | (0x06UL<<(8)));

     
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL))->SMTEN |= (0x1ul << (11));
}

void UI2C0_Init(void)
{
     
    UI2C_Open(((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)), 100000);

     
    printf("UI2C clock %d Hz\n", UI2C_GetBusClockFreq(((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL))));

     
    UI2C_SetSlaveAddr(((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)), 0, 0x15, (0U));    

    ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTIEN |= (((0x1ul << (6)) | (0x1ul << (3)) | (0x1ul << (2)) | (0x1ul << (1)))));
...
int32_t Read_Write_SLAVE(uint8_t slvaddr)
{
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        m_Event = MASTER_SEND_START;
        ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL = ((((UI2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x90000UL)))->PROTCTL & ~0x2EU) | (0x08UL));
